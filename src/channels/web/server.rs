...
use crate::channels::web::handlers::jobs::{
    job_files_list_handler, job_files_read_handler, jobs_cancel_handler, jobs_cancel_stuck_handler,
    jobs_detail_handler, jobs_events_handler, jobs_list_handler, jobs_prompt_handler,
...
pub async fn start_server(
    ...
    let protected = Router::new()
        ...
        .route("/api/jobs/cancel-stuck", post(jobs_cancel_stuck_handler))
